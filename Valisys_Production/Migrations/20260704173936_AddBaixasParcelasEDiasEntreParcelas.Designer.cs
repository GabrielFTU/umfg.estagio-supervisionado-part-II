...
namespace Valisys_Production.Migrations
{
    ...
    [Migration("20260704173936_AddBaixasParcelasEDiasEntreParcelas")]
    partial class AddBaixasParcelasEDiasEntreParcelas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("conta_pagar_codigo_seq");

            modelBuilder.HasSequence("conta_receber_codigo_seq");
            ...
            modelBuilder.Entity("Valisys_Production.Models.BaixaParcelaPagar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BaixasParcelaPagar");
                });

            modelBuilder.Entity("Valisys_Production.Models.BaixaParcelaReceber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BaixasParcelaReceber");
                });
            ...
            modelBuilder.Entity("Valisys_Production.Models.ContaPagar", b =>
                {
                    ...
                    b.Property<int?>("NumeroOcorrenciaRecorrencia")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Valisys_Production.Models.MovimentacaoCarteira", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Valisys_Production.Models.RegraRecorrencia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("NumeroOcorrencias")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.ToTable("RegrasRecorrencia");
                });
            ...
            modelBuilder.Entity("Valisys_Production.Models.BaixaParcelaPagar", b =>
                {
                    b.HasOne("Valisys_Production.Models.Carteira", "Carteira")
                        .WithMany()
                        .HasForeignKey("CarteiraId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Valisys_Production.Models.ParcelaPagar", "ParcelaPagar")
                        .WithMany("Baixas")
            ...
            modelBuilder.Entity("Valisys_Production.Models.BaixaParcelaReceber", b =>
                {
                    ...
                    b.HasOne("Valisys_Production.Models.ParcelaReceber", "ParcelaReceber")
                        .WithMany("Baixas")
            ...
            modelBuilder.Entity("Valisys_Production.Models.ContaPagar", b =>
                {
                    b.HasOne("Valisys_Production.Models.FormaPagamento", "FormaPagamento")
                        .WithMany()
                        .HasForeignKey("FormaPagamentoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Valisys_Production.Models.Pessoa", "Fornecedor")
                        .WithMany()
                        .HasForeignKey("FornecedorId");

                    b.HasOne("Valisys_Production.Models.RegraRecorrencia", "RegraRecorrencia")
                        .WithMany()
            ...
            modelBuilder.Entity("Valisys_Production.Models.MovimentacaoCarteira", b =>
                {
                    ...
                    b.HasOne("Valisys_Production.Models.ContaPagar", null)
                        .WithMany()
                        .HasForeignKey("ContaPagarId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Valisys_Production.Models.ContaReceber", null)
                        .WithMany()
                        .HasForeignKey("ContaReceberId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Valisys_Production.Models.ParcelaPagar", null)
                        .WithMany()
                        .HasForeignKey("ParcelaPagarId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Valisys_Production.Models.ParcelaReceber", null)
                        .WithMany()
                        .HasForeignKey("ParcelaReceberId")
                        .OnDelete(DeleteBehavior.Restrict);
