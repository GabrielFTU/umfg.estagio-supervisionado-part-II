...
namespace Valisys_Production.Models
{
    ...
    {
        private readonly List<BaixaParcelaPagar> _baixas = new();
        ...
        public IReadOnlyCollection<BaixaParcelaPagar> Baixas => _baixas.AsReadOnly();
        ...
        public BaixaParcelaPagar Baixar(decimal valorPago, DateTime dataPagamento,
            ...
            decimal? multa = null, string? observacoes = null, bool pagamentoIntegralObrigatorio = false)
        {
            ...
            var baixa = new BaixaParcelaPagar(carteiraId, valorPago, principal, juros, multa,
        ...
        public IReadOnlyList<BaixaParcelaPagar> EstornarBaixa()
        {
